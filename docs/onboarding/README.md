...
ctest --test-dir /tmp/lyraform-onboarding-build --output-on-failure \
  -R 'profile_free_generic_lowering|native_source_graph|flow_less_pager|namespace_ambiguity|text_outcome_boundary|math_library_boundary|strnlen_library_boundary|ctype_library_boundary'
```
...
- Does the complete 92-test suite pass at the reported revision?
