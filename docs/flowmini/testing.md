...
fresh GCC 13.3 CTest:       105 / 105
fresh Clang 18.1 CTest:     105 / 105 (ASan/UBSan; detect_leaks=0)
...
The fresh Clang 18.1.3 ASan/UBSan CTest gate is 105/105 when run with
...
aggregate boundary and native consumer-proof refusal are included in that run.
