...
| Frankencore parser exceptions cross a public boundary | Language moniker and version-requirement APIs cap input and translate internal standard or non-standard failures into unresolved/invalid structured results | `frankencore_language_probe` and `frankencore_requirements_probe` hostile cases | implemented for the current parser boundaries | Allocation-fault injection and other Frankencore/provider APIs remain open |
