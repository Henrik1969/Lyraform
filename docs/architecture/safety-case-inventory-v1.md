...
| Torn history or recovery erases committed facts | Append-only durable history with atomic append, abrupt-exit/torn-tail recovery test, quarantine, and explicit repair | ADR-0002/0003; `frankencore_error_state_history` | provisional | Deeper crash fault injection, retention, and cross-branch reconciliation are required before mutation expansion |
