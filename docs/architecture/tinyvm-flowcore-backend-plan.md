...
runtime-owned activation records; accepted records are available through a
FIFO pop boundary for an embedding. This remains metadata scheduling support,
not effectful graph dispatch. Effectful or nested-call parallel activations,
